...
import { Vendor, PurchaseRequest } from "@/app/generated/prisma/client";
...
export default function EditPurchaseRequestForm({
  pr,
  ...
  const [formData, setFormData] = useState({
    ...
    estimatedCost: pr.estimatedCost.toString(),
    budgetCategory: pr.budgetCategory || "",
    preferredVendorId: pr.preferredVendorId || "",
    requiredBy: pr.requiredBy
      ? format(new Date(pr.requiredBy), "yyyy-MM-dd")
      : "",
  });
    ...
    try {
      const res = await fetch(`/api/purchase-requests/${pr.id}`, {
        ...
        body: JSON.stringify({
          ...
          budgetCategory: formData.budgetCategory || null,
      ...
      toast.error(errorMessage || "Failed to update request");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-4xl mx-auto pb-12">
      ...
      <div className="flex items-center gap-4 mb-8 pt-4">
        ...
        <div>
          ...
          <p className="text-gray-500">Update the details of your request.</p>
        </div>
      </div>
          ...
          <section className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                required
                rows={4}
                placeholder="e.g. We are onboarding 5 new developers..."
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm sticky top-6">
            ...
            <div className="space-y-3">
              <button
                type="submit"
                disabled={loading}
                className="w-full py-2.5 rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-700 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {loading ? (
